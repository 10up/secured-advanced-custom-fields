	...
	function create_options( $field )
	{
		...
		<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
			<td class="label">
				...
				<p class="description"><?php esc_attr_e("Enter your choices one per line",'acf'); ?><br />
				<br />
				<?php esc_attr_e("Red",'acf'); ?><br />
				<?php esc_attr_e("Blue",'acf'); ?><br />
				<br />
				<?php esc_attr_e("red : Red",'acf'); ?><br />
				<?php esc_attr_e("blue : Blue",'acf'); ?><br />
				</p>
			</td>
			<td>
				<?php
