            ...
            <div id="acf-col-right">
                ...
                <div class="wp-box">
                    <div class="inner">
                        ...
                        <ul>
                            <li><a href="http://www.advancedcustomfields.com/resources/#getting-started" target="_blank"><?php esc_attr_e( "Getting Started", 'acf' ); ?></a></li>
                            <li><a href="http://www.advancedcustomfields.com/resources/#field-types" target="_blank"><?php esc_attr_e( "Field Types", 'acf' ); ?></a></li>
                            <li><a href="http://www.advancedcustomfields.com/resources/#functions" target="_blank"><?php esc_attr_e( "Functions", 'acf' ); ?></a></li>
                            <li><a href="http://www.advancedcustomfields.com/resources/#actions" target="_blank"><?php esc_attr_e( "Actions", 'acf' ); ?></a></li>
                            <li><a href="http://www.advancedcustomfields.com/resources/#filters" target="_blank"><?php esc_attr_e( "Filters", 'acf' ); ?></a></li>
                            <li><a href="http://www.advancedcustomfields.com/resources/#how-to" target="_blank"><?php esc_attr_e( "'How to' guides", 'acf' ); ?></a></li>
                            <li><a href="http://www.advancedcustomfields.com/resources/#tutorials" target="_blank"><?php esc_attr_e( "Tutorials", 'acf' ); ?></a></li>
                        </ul>
                    </div>
            ...
            <div id="acf-about" class="acf-content">
                ...
                <div class="acf-content-body">
                    <h2 class="nav-tab-wrapper">
                        <a class="acf-tab-toggle nav-tab <?php
                        if ( $tab == 'whats-new' ) {
                            echo 'nav-tab-active';
                        }
                        ?>" href="<?php echo esc_url( admin_url( 'edit.php?post_type=acf&info=whats-new' ) ); ?>"><?php esc_attr_e( "What’s New", 'acf' ); ?></a>
                        <a class="acf-tab-toggle nav-tab <?php
                           if ( $tab == 'changelog' ) {
                               echo 'nav-tab-active';
                           }
                           ?>" href="<?php echo esc_url( admin_url( 'edit.php?post_type=acf&info=changelog' ) ); ?>"><?php esc_attr_e( "Changelog", 'acf' ); ?></a>
                    <?php if ( $tab == 'download-add-ons' ): ?>
                            <a class="acf-tab-toggle nav-tab nav-tab-active" href="<?php echo esc_url( admin_url( 'edit.php?post_type=acf&info=download-add-ons' ) ); ?>"><?php esc_attr_e( "Download Add-ons", 'acf' ); ?></a>
                    <?php endif; ?>
                    </h2>
