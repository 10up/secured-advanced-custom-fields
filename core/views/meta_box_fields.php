...
<div class="fields_header">
	<table class="acf widefat">
		<thead>
			<tr>
				<th class="field_order"><?php esc_attr_e('Field Order','acf'); ?></th>
				<th class="field_label"><?php esc_attr_e('Field Label','acf'); ?></th>
				<th class="field_name"><?php esc_attr_e('Field Name','acf'); ?></th>
				<th class="field_type"><?php esc_attr_e('Field Type','acf'); ?></th>
				<th class="field_key"><?php esc_attr_e('Field Key','acf'); ?></th>
			</tr>
		</thead>
	</table>
</div>
...
<div class="fields">
	...
	<div class="no_fields_message" <?php if(count($fields) > 1){ echo 'style="display:none;"'; } ?>>
		<?php wp_kses( balanceTags( _e("No fields. Click the <strong>+ Add Field</strong> button to create your first field.",'acf') ), array('strong'=>array()) ); ?>
	</div>
	<!-- / No Fields Message -->
				...
				<tr>
					...
					<td class="field_label">
						...
						<div class="row_options">
							<span><a class="acf_edit_field" title="<?php esc_attr_e("Edit this Field",'acf'); ?>" href="javascript:;"><?php esc_attr_e("Edit",'acf'); ?></a> | </span>
							<span><a class="acf_duplicate_field" title="<?php esc_attr_e("Duplicate this Field",'acf'); ?>" href="javascript:;"><?php esc_attr_e("Duplicate",'acf'); ?></a> | </span>
							<span><a class="acf_delete_field" title="<?php esc_attr_e("Delete this Field",'acf'); ?>" href="javascript:;"><?php esc_attr_e("Delete",'acf'); ?></a></span>
						</div>
					</td>
				...
				<table class="acf_input widefat acf_field_form_table">
					<tbody>
						<tr class="field_label">
							<td class="label">
								<label><?php esc_attr_e("Field Label",'acf'); ?><span class="required">*</span></label>
								<p class="description"><?php esc_attr_e("This is the name which will appear on the EDIT page",'acf'); ?></p>
							</td>
							<td>
								<?php
						...
						<tr class="field_name">
							<td class="label">
								<label><?php esc_attr_e("Field Name",'acf'); ?><span class="required">*</span></label>
								<p class="description"><?php esc_attr_e("Single word, no spaces. Underscores and dashes allowed",'acf'); ?></p>
							</td>
							<td>
								<?php
								do_action('acf/create_field', array(
						...
						<tr class="field_type">
							<td class="label">
								<label><?php esc_attr_e("Field Type",'acf'); ?><span class="required">*</span></label>
							</td>
							<td>
								<?php
								do_action('acf/create_field', array(
						...
						<tr class="field_instructions">
							<td class="label"><label><?php esc_attr_e("Field Instructions",'acf'); ?></label>
							<p class="description"><?php esc_attr_e("Instructions for authors. Shown when submitting data",'acf'); ?></p></td>
							<td>
								<?php
								do_action('acf/create_field', array(
									'type'	=>	'textarea',
						...
						<tr class="required">
							<td class="label"><label><?php esc_attr_e("Required?",'acf'); ?></label></td>
							<td>
								<?php
								do_action('acf/create_field', array(
									'type'	=>	'radio',
						...
						<tr class="conditional-logic" data-field_name="<?php echo esc_attr( $field['key'] ); ?>">
							<td class="label"><label><?php esc_attr_e("Conditional Logic",'acf'); ?></label></td>
							<td>
								<?php
								do_action('acf/create_field', array(
									'type'	=>	'radio',
								...
								<div class="contional-logic-rules-wrapper" <?php if( ! $field['conditional_logic']['status'] ) echo 'style="display:none"'; ?>>
									...
									<ul class="hl clearfix">
										<li style="padding:4px 4px 0 0;"><?php esc_attr_e("Show this field when",'acf'); ?></li>
										...
										<li style="padding:4px 0 0 4px;"><?php esc_attr_e("these rules are met",'acf'); ?></li>
									</ul>
						...
						<tr class="field_save">
							...
							<td>
								<ul class="hl clearfix">
									<li>
										<a class="acf_edit_field acf-button grey" title="<?php esc_attr_e("Close Field",'acf'); ?>" href="javascript:;"><?php esc_attr_e("Close Field",'acf'); ?></a>
									</li>
								</ul>
							</td>
						</tr>
...
<div class="table_footer">
	<div class="order_message"><?php esc_attr_e('Drag and drop to reorder','acf'); ?></div>
	<a href="javascript:;" id="add_field" class="acf-button"><?php esc_attr_e('+ Add Field','acf'); ?></a>
</div>