	...
	function create_field( $field )
	{
		...
		<div class="acf-google-map <?php echo $o['class']; ?>" <?php echo $atts; ?>>
			...
			<div class="title">
				...
				<div class="no-value">
					<a href="#" class="acf-sprite-locate ir" title="<?php esc_attr_e("Find current location",'acf'); ?>">Locate</a>
					<input type="text" placeholder="<?php esc_attr_e("Search for address...",'acf'); ?>" class="search" />
				</div>
