...
<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
	<td class="label">
		<label><?php esc_attr_e("Return Format",'acf'); ?></label>
		<p><?php esc_attr_e("Specify the returned value on front end",'acf') ?></p>
	</td>
	<td>
		<?php
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
	<td class="label">
		<label for=""><?php esc_attr_e("Post Type",'acf'); ?></label>
	</td>
	<td>
		<?php 
...
<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
	<td class="label">
		<label><?php esc_attr_e("Filter from Taxonomy",'acf'); ?></label>
	</td>
	<td>
		<?php 
		$choices = array(
...
<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
	<td class="label">
		<label><?php esc_attr_e("Filters",'acf'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
	<td class="label">
		<label><?php esc_attr_e("Elements",'acf'); ?></label>
		<p><?php esc_attr_e("Selected elements will be displayed in each result",'acf') ?></p>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo esc_attr( $this->name ); ?>">
	<td class="label">
		<label><?php esc_attr_e("Maximum posts",'acf'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
